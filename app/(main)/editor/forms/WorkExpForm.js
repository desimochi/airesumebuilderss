...
import GenerateWorkExpButton from "./GenerateWorkExpButton";

export default function WorkExpForm({resumeData, setResumeData}){
    const form = useForm({
...
>
  ...
  >
    {fields.map((field, index) => (
      <WorkExpItmes key={field.id} id={field.id} index={index} form={form} remove={remove} />
    ))}
  </SortableContext>
</DndContext>
...
function WorkExpItmes({form, index, remove, id}){
  ...
  >
            ...
            />
                ...
                <div className="flex justify-center">
                    <GenerateWorkExpButton onWorkExpGenerated={exp => form.setValue(`workExperiences.${index}`, exp)}/>
                </div>
